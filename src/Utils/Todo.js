...
const Todo = ({
  ...
  return (
    <div className="flex justify-between gap-4 max-w-full items-center text-white bg-pink-800 rounded-2xl px-6 py-5 max-sm:py-4 max-sm:px-4">
      {val.check && (
      ...
      <div className="black w-full">
        ...
        {/* Display due date if selected */}
        {selectedDate && (
          <p className="text-gray-200 text-sm max-sm:text-xs mt-2">
